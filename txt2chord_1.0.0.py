"""Text to Chord 1.0.0 - Convert text to chords.
...
def chord_display():
    ...
    chord_one=Text(top)
    chord_one.place(x=450,y=60,height=30,width=100)
    ...
    chord_two=Text(top)
    chord_two.place(x=450,y=170,height=30,width=100)
    ...
    chord_three.place(x=450,y=280,height=30,width=100)
