"""Text to Chord 1.3.2 - Convert text to chords.
...
def aboutbox():
    ...
    url_title.configure(text="Text to Chord 1.3.2", font=("Arial",15))
    ...
    url_label2.configure(text="https://symbolform.com/text-to-chord/")
    url_label2.bind("<Button-1>", lambda e: callback("https://symbolform.com/text-to-chord/"))
