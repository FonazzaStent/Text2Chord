...
def chord_display():
    ...
    chord_two_button.place(x=450,y=120,height=30,width=100)
    ...
    chord_three_button.place(x=450,y=230,height=30,width=100)
    ...
    scale_two_combo.place(x=590,y=170,height=30,width=150)
    scale_two_button=Button(top)
    scale_two_button.configure(text="Play Scale")
    scale_two_button.place(x=610,y=120,height=30,width=100)
    ...
    scale_three_combo.place(x=590,y=280,height=30,width=150)
    scale_three_button=Button(top)
    scale_three_button.configure(text="Play Scale")
    scale_three_button.place(x=610,y=230,height=30,width=100)
